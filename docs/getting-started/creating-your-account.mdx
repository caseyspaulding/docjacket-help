...
{JSON.stringify({
  ...
  "step": [
    ...
    },
    {
      ...
      "text": "Select a checklist close to what you typically work — for example, a Residential Purchase checklist for your state. DocJacket creates a sample transaction so you can explore. You can also skip this and set up templates later.",
