...
{JSON.stringify({
  ...
  "description": "Walk through creating a transaction in DocJacket from scratch — upload a contract or enter details manually, add contacts, apply a Playbook, and review tasks.",
  "totalTime": "PT5M",
  "step": [
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      "text": "Use the Tasks tab to add tasks, add a Playbook, or generate suggested tasks. Use the closing timeline on the Overview to track deadlines.",
      "url": "https://help.docjacket.com/docs/getting-started/your-first-transaction#add-your-workflow"
    },
    {
      "@type": "HowToStep",
      "name": "Review your tasks",
      "text": "Open the Tasks tab. If your Playbook included tasks, they're already populated with calculated due dates and color-coded priorities. Add more tasks with the quick-add bar or let AI generate a tailored Playbook.",
