...
{JSON.stringify({
  ...
  "@type": "HowTo",
  "name": "How to export a transaction's file record from DocJacket",
  "description": "Export the communication log and every document for a transaction as one archive for your compliance file.",
  "totalTime": "PT1M",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Open the Reports tab",
      "text": "Open the transaction and click the Reports tab.",
      "url": "https://help.docjacket.com/docs/reports/file-record#export-the-file-record"
    },
    {
      "@type": "HowToStep",
      "name": "Click Export file record",
      "text": "In the File record card at the top of the tab, click Export file record.",
      "url": "https://help.docjacket.com/docs/reports/file-record#export-the-file-record"
    },
    {
      "@type": "HowToStep",
      "name": "Choose a date range and download",
      "text": "Leave both dates blank for the full history, keep Include files checked, and click Generate + Files.",
      "url": "https://help.docjacket.com/docs/reports/file-record#export-the-file-record"
    }
  ]
}, null, 2)}
