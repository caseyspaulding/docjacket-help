...
sidebar_position: 3
description: Drop a contract PDF in your AI assistant chat — DocJacket reads the parties, addresses, key dates, and financials, then creates the matching transaction. End-to-end PDF → live deal in one conversation.
---
