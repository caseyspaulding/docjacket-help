...
sidebar_position: 5
description: The mcp_catalog tool returns DocJacket's live tool inventory — every tool you can call right now, with descriptions, scope tiers, gotchas, pairing hints, and example arguments. Always fresh; no static list to keep in sync.
---
