...
import VideoThumbLink from '@site/src/components/VideoThumbLink';

# Connect Claude

<VideoThumbLink
  youtubeId="LSxx6t4YRAY"
  title="Watch the 30-second walkthrough"
  subtitle="Paste the URL, click Allow, ask your first question — opens on YouTube"
/>
