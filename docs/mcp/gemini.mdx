...
sidebar_position: 4
description: Connect DocJacket to Google Gemini via the Gemini CLI's MCP support. Bearer-token today; paste-URL OAuth lands when the Gemini CLI adds Dynamic Client Registration.
---
