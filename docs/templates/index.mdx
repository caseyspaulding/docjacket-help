...
{JSON.stringify({
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "From a transaction Overview, use Generate Timeline to create key dates and linked tasks from a Playbook. From the Tasks tab, use Add checklist to add saved task workflows. Smart fields and date offsets use that transaction's actual data."
      }
    },
    {
      "@type": "Question",
