  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. The DocJacket Client Portal is a secure link you send to buyers, sellers, and agents. They can view milestones, documents, tasks, and status updates without creating an account."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Portal sharing is selective — you choose which documents and milestones are visible per recipient. Each portal link is unique, can be set to expire, and engagement (who viewed it and when) is tracked."
      }
    }
  ]
})}
