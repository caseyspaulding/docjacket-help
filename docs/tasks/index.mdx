...
{JSON.stringify({
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Playbooks let you save reusable key dates, tasks, due-date offsets, assignees, and linked email templates. Use Generate Timeline from the transaction overview to create key dates and linked tasks, or use Add checklist from the Tasks tab to add saved task workflows."
      }
    }
  ]
})}
