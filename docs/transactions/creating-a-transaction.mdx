...
6. If **Smart Split** appears, review the detected documents and continue
7. Open the progress page while extraction runs
8. Review the extracted data and save the transaction
