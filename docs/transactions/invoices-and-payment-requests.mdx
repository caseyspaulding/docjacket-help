...
{JSON.stringify({
  ...
  "@type": "HowTo",
  "name": "How to send an invoice in DocJacket",
  "description": "Create and send a transaction coordination fee invoice (payment request) to an agent, broker, or team from a transaction's Payments tab and get paid online.",
  "totalTime": "PT3M",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Connect a payout account",
      "text": "In Settings, connect a Stripe payout account so you can receive payments before sending your first invoice.",
      "url": "https://help.docjacket.com/docs/transactions/invoices-and-payment-requests#before-you-can-get-paid"
    },
    {
      "@type": "HowToStep",
      "name": "Open the Payments tab",
      "text": "Open the transaction you want to bill against and go to the Payments tab.",
      "url": "https://help.docjacket.com/docs/transactions/invoices-and-payment-requests#create-an-invoice"
    },
    {
      "@type": "HowToStep",
      "name": "Create the invoice",
      "text": "Click Create Invoice, enter the fee name, amount, payer name and email, and an optional due date, then save it as a draft.",
      "url": "https://help.docjacket.com/docs/transactions/invoices-and-payment-requests#create-an-invoice"
    },
    {
      "@type": "HowToStep",
      "name": "Send it",
      "text": "Click Send to email the payer a branded invoice PDF with a Pay Invoice button. DocJacket marks the invoice Sent.",
      "url": "https://help.docjacket.com/docs/transactions/invoices-and-payment-requests#send-the-invoice"
    }
  ]
})}
</script>
