  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "In Cowork, open Organization settings → Plugins → Add plugin → GitHub. Enter docjacket-inc/claude-plugin as the repository. Mint a DocJacket AI Access token at app.docjacket.com/settings/api-access (label it 'Cowork Plugin') and paste it in Cowork's Settings → Connectors → DocJacket. The plugin's nine skills and slash commands are then available org-wide."
      }
    },
    {
      "@type": "Question",
...
{JSON.stringify({
  ...
  "step": [
    ...
    },
    {
      ...
      "text": "At app.docjacket.com/settings/api-access, click New token, use the Cowork Plugin preset, and pick a scope. Copy the plaintext token immediately — it is shown exactly once."
    },
    {
      "@type": "HowToStep",
      "position": 3,
