  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Three tiers, all live: read (40 tools — lookups such as search transactions, get key dates, list tasks, triage next actions), draft (7 tools — low-risk writes to your own records; nothing in this tier sends anything to anyone), and actions (20 tools — sending email, creating and deleting records, disclosure packages). Writes require confirmation in the assistant chat and are logged in AI Access activity."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "DocJacket → Settings → API & AI Access → Activity Log. Every tool call is logged with the client name, tool name, arguments, outcome, and latency. Filterable by client, tool, or outcome. Use this to audit what your AI assistants have been up to."
      }
    }
  ]
})}
