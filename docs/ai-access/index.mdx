...
{JSON.stringify({
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. AI Access uses OAuth 2.1 with Dynamic Client Registration — no static API keys to leak. Every connection requires your explicit consent, every tool call is logged in your AI Access activity log, and you can revoke any client at any time from DocJacket → Settings → API & AI Access."
      }
    },
    {
      "@type": "Question",
