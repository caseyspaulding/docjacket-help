  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "In Codex (or ChatGPT with MCP connectors enabled), add a new MCP server with the URL https://mcp.docjacket.com/mcp. Complete the OAuth consent screen DocJacket shows. Codex will load DocJacket's tools (47 today across read, send, draft, and contract-intake workflows) and you can start asking about your DocJacket pipeline."
      }
    },
    {
      "@type": "Question",
