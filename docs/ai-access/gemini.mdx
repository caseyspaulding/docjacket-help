  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Today: mint a personal access token at DocJacket → Settings → API & AI Access, label it 'Gemini', and configure Gemini CLI's MCP server entry with the URL https://mcp.docjacket.com/mcp and an Authorization: Bearer header. Soon: paste-URL OAuth will work the same way it does in Claude.ai and ChatGPT once the Gemini CLI ships Dynamic Client Registration support."
      }
    },
    {
      "@type": "Question",
...
{JSON.stringify({
  "@context": "https://schema.org",
  "@type": "HowTo",
  "name": "How to connect DocJacket to Gemini",
  "description": "Connect the Gemini CLI to DocJacket using a bearer token.",
  "totalTime": "PT5M",
  "tool": [
    {
      "@type": "HowToTool",
  ...
  "step": [
    {
      ...
      "text": "At app.docjacket.com/settings/api-access, click New token, label it Gemini, and pick a scope. Copy the plaintext token immediately — it is shown exactly once."
    },
    {
      "@type": "HowToStep",
      "position": 2,
      "name": "Configure the Gemini CLI",
      "text": "Open ~/.gemini/mcp.json and add a DocJacket server entry pointing at https://mcp.docjacket.com/mcp with the token as a bearer Authorization header."
    },
    {
      "@type": "HowToStep",
      "position": 3,
      "name": "Verify the connection",
      "text": "Start the Gemini CLI and ask it to use DocJacket's mcp_catalog to list the tools it can reach."
    }
  ]
})}
</script>
