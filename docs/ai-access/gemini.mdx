  ...
  "step": [
    {
      ...
      "text": "At app.docjacket.com/settings/ai-access, click New token, label it Gemini, and pick a scope. Copy the plaintext token immediately — it is shown exactly once."
    },
    {
      "@type": "HowToStep",
      "position": 2,
