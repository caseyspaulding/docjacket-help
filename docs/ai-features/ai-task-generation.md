...
<!-- Screenshot: AI task generation suggestions with checkboxes -->
...
Both AI generation and [task templates](./ai-task-generation.md) can populate your task list. Here's when to use each:
