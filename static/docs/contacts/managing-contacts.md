...
When quick-creating a transaction contact, DocJacket checks for likely duplicates by name, email, or phone before creating the new record. If a match exists, you can use the existing contact instead of creating another row.
