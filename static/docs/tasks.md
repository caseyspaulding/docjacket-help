...
Inside a transaction, tasks are grouped by checklist section. Each section shows progress, can be collapsed, and can be saved back as a checklist template. Rows show the task name, planned date, completed date, notes, email/send indicators, and portal visibility.
