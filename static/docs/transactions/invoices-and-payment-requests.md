...
## Setting a default TC fee

To have your standard TC fee posted automatically as a fee line on every new deal's **Fees & Payments** ledger, set it once under **Settings > Default Fees** (`/settings/fees`), with optional different amounts for Buyer, Seller, and Dual deals. The default TC fee is not under Billing or Organization. See [Default Fees](../settings/transaction-configuration.md#default-fees-your-default-tc-fee).
