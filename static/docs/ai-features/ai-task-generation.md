...
sidebar_position: 3
description: Let AI analyze your DocJacket transaction and suggest a task Playbook based on property type, state, parties, and timeline.
---

<!-- Canonical: https://help.docjacket.com/docs/ai-features/ai-task-generation -->
<!-- Source: docs/ai-features/ai-task-generation.mdx -->

# AI Task Generation

Don't want to build your task Playbook from scratch? Let AI analyze your transaction and suggest tasks for you.
...
The selected tasks are added to the transaction with their suggested name, description, and priority. Review the generated list before adding it; the generator is meant to supplement your judgment, not replace a Playbook you already trust.
...
Both AI generation and [Playbooks](/docs/templates/task-templates) can populate your task list. Here's when to use each:

| Use AI generation when... | Use templates when... |
|--------------------------|----------------------|
| You want tasks tailored to this specific deal | You have a proven Playbook you use every time |
