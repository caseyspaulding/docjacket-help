...
Smart Fields are reusable data placeholders. They let DocJacket pull transaction information into templates, documents, reports, and messages without retyping the same values.
...
2. Review the existing fields and groups
3. Add custom fields when your team needs to track additional data
4. Organize related fields into groups when helpful
