...
- Shared documents grouped by category
...
You control visibility at the document and task level, so sensitive items stay private unless you specifically share them. Agent portals may also show agent-facing financial details and recent activity that client portals do not show.
