...
sidebar_position: 1
description: Use DocJacket's day-to-day work queues to see what needs attention, route inbound work, review AI drafts, and finish extraction saves.
---
...
- [Pending Review](./pending-review.md) - Approve, edit, or reject AI-proposed drafts before they run
...
Use **Pending Review** when AI or connected tools prepared something that needs approval before DocJacket sends or applies it.
