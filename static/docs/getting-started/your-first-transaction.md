...
<!-- Source: docs/getting-started/your-first-transaction.mdx -->
...
new transaction button with dropdown options
...
AI extraction review screen with extracted fields
...
tasks tab with color-coded priorities
