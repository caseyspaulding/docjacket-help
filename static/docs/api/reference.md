...
- **Raw OpenAPI 3.1.1 specification:** [JSON](https://api.docjacket.com/openapi.json) · [YAML](https://api.docjacket.com/openapi.yaml)
...
|---|---|---|
| **Organization key** | `mcp_at_…` | Acts within a single organization. Mint one under **Settings → Advanced → API & AI Access** (API keys tab). Covers every section except Organizations (Partner). |
