...
**"Token is invalid, expired, or revoked"** — Either you revoked the client in DocJacket → Settings → AI Access, or the refresh token expired after 90 days of inactivity. Re-consent to reconnect.
