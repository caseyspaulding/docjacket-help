...
sidebar_position: 1
description: Configure your DocJacket organization, brand, users, offices, integrations, calendars, transactions, documents, automation, billing, SMS, and notifications.
---

<!-- Canonical: https://help.docjacket.com/docs/settings -->
<!-- Source: docs/settings/index.md -->
...
- [Organization Settings](./organization-settings.mdx) — Organization identity, report branding, reminders, automation review, and email subject defaults
- [Brand and Profile](./brand-and-profile.md) — Brand presets, public-page attribution, profile details, timezone, and SMS consent
- [Front Door](../front-door/index.mdx) — Public intake, services, leads, and branded landing surfaces
...
- [Transaction Configuration](./transaction-configuration.md) — Transaction roles, default TC fees, statuses, field options, custom fields, contingencies, and key date statuses
